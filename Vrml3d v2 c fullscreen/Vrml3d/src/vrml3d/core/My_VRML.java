...
import vrml3d.GUI.Vrml3dView;
import vrml3d.readerConf.RWConf;
...
public class My_VRML {
    ...
    private Canvas3D Tela2;
    private Aparelho App = new Aparelho();
    private int i = 0;
    private Camera cam;    
    private BoundMulti forbiden = new BoundMulti("Negad");
    private Vrml3dView view;
    private RWConf configurations;

    public My_VRML(JPanel jPanel1,JPanel panel2,Vrml3dView view) {
        ...
        setCanvas3D(Tela);
        this.setView(view);
        configurations = new  RWConf();
        setClassPath(this.getPath());


        Tela2 = new Canvas3D(gd[0].getBestConfiguration(g3));
        Tela.setDoubleBufferEnable(true);
        Tela2.setSize(panel2.getSize());
        panel2.add(Tela2);


        Viewer view2 = new Viewer(Tela2);
        ViewingPlatform vp2 = new ViewingPlatform(1);

        Objeto temp2 = new Objeto(EMG);
        temp2.setXYZ(1.3, 0.2,0);
        temp2.setRotY(90);
//        temp2.setRotX(180);

        vp2.getViewPlatformTransform().setTransform(temp2.transform);
        view2.setViewingPlatform(vp2);
        Get_Universe().addBranchGraph(vp2);
...
//        App.getLivro().SetRotacao(90, 0);
        ...
        new Vrml3dPainel(10, this,derivações).setVisible(true);
        App.setNumplugs(10);
...
//        return tg;
    ...
    public void setPath(String Path) {
        configurations.write(Path);
    }

    /**
     * @return the view
     */
    public Vrml3dView getView() {
        return view;
    }
     ...
     */
    public void setView(Vrml3dView view) {
        this.view = view;
    }
